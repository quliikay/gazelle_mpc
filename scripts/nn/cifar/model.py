...
model_urls = {
    ...
    'cifar10_minionn': 'cifar10_minionn.pth',
}
...
class CIFARMiniONN(nn.Module):
    def __init__(self):
        super(CIFARMiniONN, self).__init__()
...
def get(model_name, model_dir, pretrained=False):
    if model_name == 'cifar10':
        ...
        model = cifar100(128, pretrained='log/cifar100/best-135.pth')
    elif model_name == 'cifar10_minionn':
        model = CIFARMiniONN()
    else:
